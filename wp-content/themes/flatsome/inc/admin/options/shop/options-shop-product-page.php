...
Flatsome_Option::add_field( '', array(
	...
	'section'         => 'product-page',
	'default'         => '<span class="description customize-control-description">The default WooCommerce gallery has been activated in section Advanced → WooCommerce. Multiple Flatsome gallery options are disabled.</span>',
) );
